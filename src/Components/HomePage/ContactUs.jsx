...
const ContactUs = () => {
  return (
    <div className="bg-primary_coral max-h-[30vh] relative overflow-hidden text-center text-state_green">
      ...
      <img src={bg_6} alt="" className="relative md:bottom-0 bottom-8 lg:bottom-10 " />
    </div>
  );
};
